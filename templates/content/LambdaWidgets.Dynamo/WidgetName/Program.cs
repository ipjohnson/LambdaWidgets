...
// Tool and sets the same variable the service would have - which is what puts the widget under a
...
using var emulator = await LambdaEmulator.StartIfLocal(typeof(WidgetNameApp));
...
new WidgetNameApp().PopulateServiceCollection(services);
