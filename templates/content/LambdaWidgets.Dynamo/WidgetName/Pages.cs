...
public class Pages(IItemLookups lookups) {
    ...
    /// fields.</b> That is the whole of paging here: a widget gets no cookies, no local storage and
    /// no state between invocations, so the page the viewer is on is a property of the link they
    /// are about to click rather than of anything on the server.
    /// </remarks>
    [Get("/look-up")]
